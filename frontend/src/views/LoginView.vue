<!-- <template>
  ...
  <!-- <template>
    <div class="container">
      ...
      <div class="btn">
        <button class="login" @click="showForm('login')">Login</button>
        <button class="signup" @click="showForm('signup')">Signup</button>
      </div>
  
      <div class="form-section">
        <div class="login-box" v-if="activeForm === 'login'">
          <input
            type="email"
            class="email ele"
            placeholder="Email"
  ...
  export default {
    ...
    methods: {
      ...
      toggleForm(form) {
        ...
        // Reset forms and error message when toggling between forms
        this.loginForm = {
          emailAdd: "",
          userPass: "",
        };
